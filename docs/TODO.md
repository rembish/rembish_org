...
- [x] Restructure repos into rembish_org-scope parent directory
- [x] Set up localhost docker-compose dev environment
- [x] Port CV page to new React frontend
- [x] Rewrite contact form with anti-spam (honeypot + timing)
- [x] Implement Google OAuth login (single admin user)
- [x] Remove Trips and Drone features
