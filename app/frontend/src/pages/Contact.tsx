        ...
        <div className="contact-grid">
          <div className="contact-info">
            ...
            <div className="info-item">
              ...
              <div>
                <h4>Email</h4>
                <p><a href="mailto:alex@rembish.org">alex@rembish.org</a></p>
              </div>
            </div>
            ...
            <div className="contact-socials">
              <a href="https://t.me/rembish" title="Telegram" aria-label="Telegram">
                <BiLogoTelegram />
              </a>
          ...
          <form className="contact-form" onSubmit={handleSubmit}>
            ...
            {formState.status === 'success' && (
              <div className="form-message form-success">{formState.message}</div>
            )}
